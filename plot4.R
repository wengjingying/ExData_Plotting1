...
windows()
par(mfrow=c(2,2))
plot(ele$Time,ele$Global_active_power,type="l",xlab="",ylab="Global Active Power")
plot(ele$Time,ele$Voltage,type="l",xlab="datetime",ylab="Voltage")
plot(ele$Time,ele$Sub_metering_1,type="l",xlab="",ylab="Energy sub metering")
points(ele$Time,ele$Sub_metering_2,type="l",col="red")
points(ele$Time,ele$Sub_metering_3,type="l",col="blue")
legend("topright",c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),bty = "n",cex=0.9,lty=c(1,1,1),col=c("black","red","blue"))
plot(ele$Time,ele$Global_reactive_power,type="l",xlab="datetime",ylab="Global_reactive_power")
